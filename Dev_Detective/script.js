...
//we fetch all required variables using 'get' function or we can fetch using regular method 
...
//this event listner is for 'enter' keyword
...
//event listner for 'input' tag when we start typing then it hides the 'no search result' paragraph
input.addEventListener("input", function () {
  noresults.style.display = "none";
});

//event listner for light and dark mode
